...
mixin _$JobStore on _JobStore, Store {
  ...
  @override
  bool get showErrorState => (_$showErrorStateComputed ??= Computed<bool>(
  ...
  late final _$showFilterAtom = Atom(
    name: '_JobStore.showFilter',
    context: context,
  );
  ...
  late final _$fetchJobsAsyncAction = AsyncAction(
    '_JobStore.fetchJobs',
    context: context,
  );
  ...
  Future<void> fetchJobs({bool loadMore = false}) {
    return _$fetchJobsAsyncAction.run(
      () => super.fetchJobs(loadMore: loadMore),
    );
  }

  late final _$applyJobAsyncAction = AsyncAction(
    '_JobStore.applyJob',
    context: context,
  );
  ...
  Future<void> applyJob(String jobId) {
    return _$applyJobAsyncAction.run(() => super.applyJob(jobId));
  }

  late final _$_JobStoreActionController = ActionController(
    name: '_JobStore',
    context: context,
  );
